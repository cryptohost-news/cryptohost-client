  ...
  return (
    <>
      <Head>
        ...
        <link rel="canonical" href="https://crypto-host.net/privacy" />
        <meta property="og:locale" content="ru_RU" />
        <meta property="og:site_name" content="CRYPTOHOST" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="CRYPTOHOST — приватность" />
        <meta
          property="og:description"
          content="CRYPTOHOST — все, что нужно знать о блокчейн и криптовалютах простыми словами. Обучающие статьи для новичков, свежие новости, обзоры проектов и другое!"
        />
        <meta property="og:url" content="https://crypto-host.net/privacy" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              '@context': 'https://crypto-host.net/privacy',
              '@type': 'WebSite',
              name: 'CRYPTOHOST — приватность',
              description:
